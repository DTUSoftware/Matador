...
public class GameGUI {
    ...
    public GameGUI(GUI_Field[] fields) {
    ...
    private LanguageManager getLanguageManager() {
        return GUIManager.getInstance().getLanguageManager(guiID);
    }

    private GameManager getGameManager() {
        return GUIManager.getInstance().getGameManager(guiID);
    }
    ...
    public boolean askPrompt(String question) {
        return gui.getUserLeftButtonPressed(question, getLanguageManager().getString("yes"), getLanguageManager().getString("no"));
    }
    ...
    public void askLanguage() {
        HashMap<String, Locale> localeMap = getLanguageManager().getLocalesMap();
        ...
        getLanguageManager().setLocale(locale);
...
//        return gui.getUserLeftButtonPressed("Choose a Language // Vælg et sprog", "English", "Danish");
    ...
    public int askNumber(int min, int max) {
        ...
        String number = gui.getUserSelection(getLanguageManager().getString("choose_a_number"), numbers);
    ...
    public GUI_Car.Type askCarType() {
        ...
        String carType = gui.getUserSelection(getLanguageManager().getString("choose_player_car"), carTypes);
    ...
    public void waitUserRoll() {
        gui.showMessage(getLanguageManager().getString("click_to_roll"));
    }
    ...
    public Field movePlayerField(UUID playerID, int fieldNumber) {
        ...
        Field field = getGameManager().getGameBoard().getField(fieldNumber);
        assert (field != null);
    ...
    public void showChanceCard(String cardText) {
        ...
        showMessage(getLanguageManager().getString("got_a_chance_card"));
        gui.displayChanceCard();
        gui.setChanceCard(getLanguageManager().getString("no_chance_card"));
    }
}
